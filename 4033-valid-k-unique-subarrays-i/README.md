<h2><a href="https://leetcode.com/problems/valid-k-unique-subarrays-i">4033. Valid K-Unique Subarrays I</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>

<p>You are also given a 2D integer array <code>queries</code>, where <code>queries[i] = [l<sub>i</sub>, r<sub>i</sub>]</code> represents the <strong>subarray</strong> <code>nums[l<sub>i</sub>..r<sub>i</sub>]</code>.</p>
...
<ul>
	...
	<li>The <strong>frequency</strong> of every number in the <strong>subarray</strong> is <strong>even</strong>.</li>
</ul>

<p><strong>Note:</strong> The <strong>frequency</strong> of a number in a subarray is the number of times it occurs in that subarray.</p>
